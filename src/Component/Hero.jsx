    ...
    <>
      ...
      <div className="container-fluid hero section" id="hero">
        <div className="row justify-content-center gy-4">
          <div className="col-lg-5  col-md-8 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div className="col-lg-5 col-md-4  order-1 order-lg-2 hero-img">
